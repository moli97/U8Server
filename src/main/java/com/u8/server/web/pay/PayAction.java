...
public class PayAction extends UActionSupport{
    ...
    public void getOrderID(){
        ...
        try{
            ...
            final UOrder order = orderManager.generateOrder(user, money, productID, productName, productDesc, roleID,roleName,roleLevel, serverID,serverName, extension, notifyUrl);
