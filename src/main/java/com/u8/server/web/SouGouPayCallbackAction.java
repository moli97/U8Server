...
public class SouGouPayCallbackAction extends UActionSupport {
    ...
    public void payCallback(){
        try{
            ...
            if(order.getMoney() > realMoney){
                Log.e("订单金额不一致! local orderID:"+localOrderID+"; money returned:"+realMoney+"; order money:"+order.getMoney());
            }
    ...
    private boolean isValid(UChannel channel){
        ...
        sb.append("amount1=").append(amount1)
                .append("&amount2=").append(amount2)
                .append("&appdata=").append(appdata)
